...
public class Codegen {
  ...
  void munchStm(Tree.MOVE s) {
    // MOVE can have multiple different Exp in its args
    // Do different things based on what's in the left and right subtrees
    // E.g. MOVE(TEMP, CONST) is different emit than MOVE(MEM, CONST)
    // Should we make different MOVE munch funcs or just munch each Exp?
  }
